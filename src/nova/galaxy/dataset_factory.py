...
class DatasetFactory():
    '''
    A factory for creating and mass uploading of AbstractData subclasses
    '''
    ...
    def create_dataset(store, config):
        ...
        config: Dict[String, String]
            Dictionary of configuration information in the format
            {
                "id": "my id",
                "output_name": "my name"
            }
        ...
        # Avoid circular imports for this singleton class by importing packages lazily
    ...
    def create_dataset_collection(store, config):
        '''
        Create a DatasetCollection with the given configuration.
